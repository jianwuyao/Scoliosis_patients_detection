...
extern "C" JNIEXPORT jlong JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeCreateNetFromFile(
        JNIEnv *env, jclass type, jstring modelName_) {
    const char *modelName = env->GetStringUTFChars(modelName_, nullptr);
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeReleaseNet(
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeCreateSession(
...
extern "C" JNIEXPORT void JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeReleaseSession(
        JNIEnv *env,jclass type, jlong netPtr,jlong sessionPtr) {
    auto net     = (MNN::Interpreter *)netPtr;
    auto session = (MNN::Session *)sessionPtr;
    net->releaseSession(session);
}

extern "C" JNIEXPORT jint JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeRunSession(
        JNIEnv *env, jclass type, jlong netPtr, jlong sessionPtr) {
    auto net     = (MNN::Interpreter *)netPtr;
    auto session = (MNN::Session *)sessionPtr;
...
extern "C" JNIEXPORT jint JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeRunSessionWithCallback(
    ...
    auto *tensoraddrs = (jlong *)env->GetLongArrayElements(jtensoraddrs, nullptr);
...
extern "C" JNIEXPORT jint JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeReshapeSession(
        JNIEnv *env, jclass type, jlong netPtr, jlong sessionPtr) {
    auto net     = (MNN::Interpreter *)netPtr;
    auto session = (MNN::Session *)sessionPtr;
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeGetSessionInput(
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeGetSessionOutput(
        JNIEnv *env, jclass type, jlong netPtr, jlong sessionPtr, jstring name_) {
    auto net     = (MNN::Interpreter *)netPtr;
    auto session = (MNN::Session *)sessionPtr;
    if (nullptr == name_) {
...
extern "C" JNIEXPORT void JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeReshapeTensor(
        JNIEnv *env, jclass type, jlong netPtr, jlong tensorPtr, jintArray dims_) {
    jint *dims   = env->GetIntArrayElements(dims_, nullptr);
...
extern "C" JNIEXPORT void JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeSetInputIntData(
        JNIEnv *env, jclass type, jlong netPtr, jlong tensorPtr, jintArray data_) {
    auto tensor = (MNN::Tensor *)tensorPtr;

    jint *data    = env->GetIntArrayElements(data_, nullptr);
...
extern "C" JNIEXPORT void JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeSetInputFloatData(
        JNIEnv *env, jclass type, jlong netPtr, jlong tensorPtr, jfloatArray data_) {
    auto tensor = (MNN::Tensor *)tensorPtr;

    jfloat *data  = env->GetFloatArrayElements(data_, nullptr);
    auto dataSize = env->GetArrayLength(data_);
...
extern "C" JNIEXPORT jintArray JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeTensorGetDimensions(
        JNIEnv *env, jclass type, jlong tensorPtr) {
    auto tensor     = (MNN::Tensor *)tensorPtr;
    auto dimensions = tensor->buffer().dimensions;

    jintArray result = env->NewIntArray(dimensions);

    jint *destDims = env->GetIntArrayElements(result, nullptr);
...
extern "C" JNIEXPORT jint JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeTensorGetUINT8Data(
        JNIEnv *env, jclass type, jlong tensorPtr, jbyteArray jdest) {
    auto tensor = (MNN::Tensor *)tensorPtr;
    if (nullptr == jdest) {
...
extern "C" JNIEXPORT jint JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeTensorGetIntData(
        JNIEnv *env, jclass type, jlong tensorPtr, jintArray dest) {
    auto tensor = (MNN::Tensor *)tensorPtr;
    if (nullptr == dest) {
        return tensor->elementSize();
    }
    ...
    if (tensor->host<int>() == nullptr) {
        // GPU buffer
        hostTensor = std::make_unique<MNN::Tensor>(tensor, tensor->getDimensionType(), true);
        tensor->copyToHostTensor(hostTensor.get());
        tensor = hostTensor.get();
    }
...
extern "C" JNIEXPORT jint JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeTensorGetData(
        JNIEnv *env, jclass type, jlong tensorPtr, jfloatArray dest) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeConvertBufferToTensor(
    ...
    jbyte *bufferData = env->GetByteArrayElements(jbufferData, nullptr);
    ...
    // mean、normal
    jfloat *mean   = env->GetFloatArrayElements(mean_, nullptr);
    jfloat *normal = env->GetFloatArrayElements(normal_, nullptr);
    ...
    // matrix
    jfloat *matrixValue = env->GetFloatArrayElements(matrixValue_, nullptr);
...
extern "C" JNIEXPORT jboolean JNICALL Java_org_jwyao_mnnpose_mnn_MNNNetNative_nativeConvertBitmapToTensor(
